...
<body>
    ...
    <div container>
        ...
        <div id="conteudo">
            <h2>Cadastros</h2><br>
            <h4>Selecione o tipo de cadastro que deseja realizar:</h4>
            <nav id="cad-opcoes">
                <a href="cadastro/cproduto.php">Produto</a>
                <a href="cadastro/ctransportadora.php">Transportadora</a>
                <a href="cadastro/cfornecedores.php">Fornecedor</a>
                <a href="cadastro/cusuarios.php">Usuário</a>
            </nav>
        </div>
    </div>
</body>
